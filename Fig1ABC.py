...
from billiard_utils import Triangle, trajectory_collisions
...
xs, ys, ts = trajectory_collisions(x0, y0, vx0, vy0, t, triangle)
...
for ax in [a, b, c]:
    ...
    # Plot triangle
    linewidth = 3
    """ Sides of the triangle are plotted with solid_capstyle='round'
    to create rounded corners and avoid the sharp square corners of
    each line."""
    ax.plot([L1l, L1r], [0, 0], 'k',
            linewidth=linewidth, solid_capstyle='round')
    ax.plot([L1l, 0], [0, L2], 'k',
            linewidth=linewidth, solid_capstyle='round')
    ax.plot([L1r, 0], [0, L2], 'k',
            linewidth=linewidth, solid_capstyle='round')
