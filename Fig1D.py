...
for i in range(len(TIMES)):
	x_list, y_list,temp1,temp2 = propogate_list(x_list,y_list,vx_list,vy_list,
												dts[i],triangle)

	# Row 1
	ax[0,i].plot(x_list,y_list,'.',markersize=5)
	linewidth=3
	ax[0,i].plot([triangle.L1l,triangle.L1r],[0,0],'k',linewidth=linewidth,
				 solid_capstyle='round')
	ax[0,i].plot([triangle.L1l,0],[0,triangle.L2],'k',linewidth=linewidth,
				 solid_capstyle='round')
	ax[0,i].plot([triangle.L1r,0],[0,triangle.L2],'k',linewidth=linewidth,
				 solid_capstyle='round')
	ax[0,i].axis('off')
	...
	ax[2,i].imshow(rhos,origin='lower',
		extent=(triangle.L1l,triangle.L1r,0,triangle.L2),vmin=0,vmax=3)
