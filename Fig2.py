...
if 1: # Fig 2B
	...
	plt.plot(ts,x2_avg,'--',linewidth=1.5)#,color='#d62828')
	plt.plot(ts,y2_avg,linewidth=1.5)#,color='purple')
	...
	plt.legend([r'$\langle q_1\rangle$',r'$\langle q_2\rangle$',r'$\langle q_1^{\;2}\rangle$',r'$\langle q_2^{\;2}\rangle$'],prop={'size': 13})
	plt.savefig('fig2B.pdf',transparent=True)
	plt.show()


if 0: # Fig 2C (Comparison of generalized entropys)
	S_1 = file['S_1s']
	S_2 = file['S_2s']
	S_3 = file['S_3s']
	S_4 = file['S_4s']
